...
// 2. จัดเตรียม URL สำหรับ QR Code ผ่าน Proxy เพื่อให้บันทึกภาพได้
$api_url = "https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=" . urlencode($row['QR_CODE']);
$qr_proxied = "get_qr.php?url=" . urlencode($api_url);
?>
...
<head>
    ...
    <style>
        body {
            background: #0f172a; /* พื้นหลังสีเข้มดูพรีเมียม */
